...
// 이러한 배열을 밀집 배열이라한다
// 일반적인 의미 배열은 각 요소가 동일한 데이터 크기를 가지며 빈틈없이 연속적으로 이어져 있으므로 다음과 같이 인덱스를 통해
...
// 즉, 배열의 요소를 위한 각각의 메모리 공간은 동일한 크기를 가지 않아도되며 연속으로 이어져 있지않을 수도 있다
