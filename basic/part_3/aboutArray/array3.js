...
console.log(arrspilce);
console.log(arrspliceResult);
...
console.log(arrSlice.slice(0, 1))
console.log(arrSlice.slice(1, 2))
console.log(arrSlice)
console.log(arrSlice.slice(1)) // arr[1] 이후 부터 모든 요소를 복사하여 반환
console.log(arrSlice.slice(-1)) // 배열의 끝에서 부터 한개 복사해서 반환
console.log(arrSlice.slice(-2)) // 배열의 끝에서 부터 두개 복사해서 반환
